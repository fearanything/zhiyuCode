...
public class MediaFile
{
  ...
  {
    String url = "http://file.api.weixin.qq.com/cgi-bin/media/upload?access_token=" + TokenProxy.accessToken() + "&" + "type" + "=" + this.type.name();
  ...
  {
    String url = "http://file.api.weixin.qq.com/cgi-bin/media/get?access_token=" + TokenProxy.accessToken() + "&" + "media_id" + "=" + this.mediaId;
