...
public class DictionariesController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		if (StringUtils.isNotEmpty(BIANMA)) {
			PageData param = new PageData();
			param.put("BIANMA", BIANMA);
			PageData parent = dictionariesService.findByBianma(param);
			DICTIONARIES_ID = parent.getString("DICTIONARIES_ID");
		}
