...
<body>
    ...
    <iframe id="iframe1" class="iframe" src="<%=basePath%>frontend/demo_embedded_for_iframe.html?IFRAME_ID=${pd.IFRAME_ID}&MONITOR_ID=${pd.MONITOR_ID}" scrolling="no" frameborder="0" width="390px" height="280px"></iframe>
</body>
...
<script type="text/javascript">	
	...
	//var iframeWin = $(window.parent.document).find("iframe5");
