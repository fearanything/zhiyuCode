...
<body>
    ...
    <iframe id="iframe1" class="iframe" src="<%=basePath%>frontend/demo_embedded_for_iframe1.html?IFRAME_ID=${pd.IFRAME_ID}&MONITOR_ID=${pd.MONITOR_ID}" scrolling="no" frameborder="0" width="100%" height="100%"></iframe>
</body>
