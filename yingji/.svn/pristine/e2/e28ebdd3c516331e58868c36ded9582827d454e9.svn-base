						...
						<div id="zhongxin" style="padding-top: 13px">
							<table id="table_report" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<td>
											<select class="chosen-select form-control" name="FENGXIAN_AREA" id="FENGXIAN_AREA" data-placeholder="请选择区域" style="vertical-align:top;width: 98%;">
												<option value=""  > </option>
...
<%--													<option value="${map.DICTIONARIES_ID}" <c:if test="${map.DICTIONARIES_ID == pd.FENGXIAN_AREA}">selected</c:if> >${map.NAME}</option>--%>
									...
									<tr>
										...
										<td>
											...
											<div id="selectCInput1" class="select-editable">
												...
												<input type="text" name="FENGXIAN_HAZARD" id="FENGXIAN_HAZARD" value="${pd.FENGXIAN_HAZARD}"  maxlength="255" placeholder="这里输入危险源" title="危险源" style="width:80%;"/>
											</div>
									...
									<tr>
										<td style="width:110px;text-align: right;padding-top: 13px;"><span style="color: red;">*</span>可能导致的事故类型:</td>
										<td>
											<select class="chosen-select form-control" name="FENGXIAN_ACCIDENT_TYPE" id="FENGXIAN_ACCIDENT_TYPE" data-placeholder="请选择可能导致的事故类型" style="vertical-align:top;width: 98%;">
												<option value=""  > </option>
