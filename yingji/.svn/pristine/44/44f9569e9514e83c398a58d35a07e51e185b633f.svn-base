...
public class NoticeController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("backend/notice/notice_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("backend/notice/notice_edit");
		List<PageData> typhoonList=typhoonService.listAll(pd);
		mv.addObject("typhoonMap", typhoonList);
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("NOTICE_ID"));	    //1
			vpd.put("var2", varOList.get(i).getString("TYPHOON_ID"));	    //2
			vpd.put("var3", varOList.get(i).getString("NOTICE_DATETIME"));	    //3
			vpd.put("var4", varOList.get(i).getString("NOTICE_TITLE"));	    //4
			vpd.put("var5", varOList.get(i).getString("NOTICE_CONTENT"));	    //5
