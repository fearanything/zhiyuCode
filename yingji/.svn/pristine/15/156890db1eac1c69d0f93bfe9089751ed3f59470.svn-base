...
public class M_fengxian{ 
	...
	private String RESPONSIBILITY_UNIT;			//责任单位(组织机构)
	private String RESPONSIBILITY_PEOPLE;			//责任人
	private String RESPONSIBILITY_PHONE;			//责任人联系方式
	private String RECOGNITION_TIME;			//识别时间
	private String START_TIME;			//开始时间
	private String END_TIME;			//结束时间
	private String FENGXIAN_NUMBER;			//流水号
	...
	public String getRESPONSIBILITY_PEOPLE() {
		return RESPONSIBILITY_PEOPLE;
	}
	public void setRESPONSIBILITY_PEOPLE(String RESPONSIBILITY_PEOPLE) {
		this.RESPONSIBILITY_PEOPLE = RESPONSIBILITY_PEOPLE;
	}
	...
	public String getFENGXIAN_NUMBER() {
		return FENGXIAN_NUMBER;
	}
	public void setFENGXIAN_NUMBER(String FENGXIAN_NUMBER) {
		this.FENGXIAN_NUMBER = FENGXIAN_NUMBER;
	}
