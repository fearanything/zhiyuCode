 ...
 * @version 1.0
 */
public class ObjectExcelViewSC extends AbstractXlsView {
...
//        Cell hiddencell = null;
        ...
        //设置责任单位下拉框
        createDropDownBoxMore(sheet,helper,allUnitString,2,999,14,14,hiddenSheet3);

        //设置填报单位下拉框
        createDropDownBoxMore(sheet,helper,allUnitString,2,999,17,17,hiddenSheet3);
