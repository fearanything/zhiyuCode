...
<body id="main">
    ...
    <!-- 2.中部信息盒子开始 -->
    <div class="yingji" style="background-image: url(<%=basePath%>frontend/images/subPage-bg.png); background-size: cover; width: 111rem; height: 56rem; margin: 2rem auto; padding: 80px 60px; box-sizing: border-box;" >
