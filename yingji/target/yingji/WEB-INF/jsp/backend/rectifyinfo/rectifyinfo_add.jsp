			...
			<div class="page-content">
				<div class="row">
					...
					<form action="rectifyinfo/${msg}.do" name="Form" id="Form" method="post">
						...
						<input type="hidden" name="RECTIFY_STAGE" id="RECTIFY_STAGE" value="1"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover" style="width: 1000px;margin: 0 auto;">
							...
							<tr>
								...
								<td>
									<select class="chosen-select form-control" name="PROJECT_NAME" id="PROJECT_NAME" data-placeholder="项目名称" style="vertical-align:top;width: 98%;">
										<option value="" ></option>
...
<%--									<a class="btn btn-mini btn-primary" onclick="goNewProject();">保存</a>--%>
								</td>
							</tr>
							<tr>
...
<%--									</select>--%>
							...
							<tr>
								<td style="text-align: center;" colspan="10">
									<a class="btn btn-mini btn-primary" onclick="save('2');">保存</a>
									<a class="btn btn-mini btn-primary" onclick="save('1');">提交</a>
...
<!-- /.main-container -->
	...
	<script type="text/javascript">
		...
		function submit() {
			...
			$.ajax({
				...
				data : {
					...
					"RECTIFY_STAGE": $("#RECTIFY_STAGE").val(),
					"REPORTING_UNIT_FIRST": $("#REPORTING_UNIT_FIRST").val(),
					"REPORTING_PERSON_FIRST": $("#REPORTING_PERSON_FIRST").val(),
					"RECTIFYINFO_AREA": $("#RECTIFYINFO_AREA").val()
				},    //参数值
		...
		function goNewProject(){
			...
			diag.Drag=true;
			diag.Title ="新增";
			diag.URL = '<%=basePath%>morg/goAdd.do?ISORG=0';
			diag.Width = 800;
			diag.Height = 700;
