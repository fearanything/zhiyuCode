      ...
      <div class="page-content">
        <div class="row">
          <div class="col-xs-12">
            ...
            <!-- 检索  -->
            <form action="rectifyinfo/goRectifyInfoSNC?RECTIFY_STAGE=2" method="post" name="Form" id="Form">
                ...
                <div style="width: 2000px;">
                  <table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
                    ...
                    <tr>
                      ...
                      <th class="center" style="width:150px;">安全隐患编码</th>
                      <th class="center" style="width:150px;">组织机构</th>
                      <th class="center" style="width:150px;">项目名称</th>
<%--                      <th class="center">文件编号</th>--%>
                      <th class="center" style="width:200px;">隐患情况</th>
                      <th class="center">隐患类别</th>
                      <th class="center">隐患级别</th>
                      <th class="center">隐患因素</th>
                      <th class="center">整改期限</th>
                      <th class="center">填报单位</th>
                      <th class="center">填报人</th>
                      <th class="center">发现时间</th>
<%--                      <th class="center" style="width:200px;">整改措施</th>--%>
<%--                      <th class="center">责任单位</th>--%>
...
<%--                                    <a class="btn btn-xs btn-success" onclick="rectifySecond('${var.RECTIFY_ID}');">--%>
<%--                                      整改--%>
<%--                                    </a>--%>
<%--                                  <c:if test="${QX.del == 1}">--%>
...
<%--                                          </a>--%>
                              ...
                              <td class='center'>
                                <c:forEach items="${orgList}" var="map" varStatus="vs">
                                  <c:if test="${map.ORG_ID == var.ORG_ID}">${map.ORG_NAME}</c:if>
                                </c:forEach>
                              </td>
                              <td class='center'>
...
<%--                              <td class='center'>${var.RESPONSIBLE_UNIT}</td>--%>
                            </tr>
...
<script type="text/javascript">
  ...
  function edit(Id){
    ...
    diag.Drag=true;
    diag.Title ="编辑";
    diag.URL = '<%=basePath%>rectifyinfo/goEdit.do?RECTIFY_ID='+Id+"&RECTIFY_STAGE=2";
    diag.Width = 900;
    diag.Height = 800;
    diag.Modal = true;				//有无遮罩窗口
    diag. ShowMaxButton = true;	//最大化按钮
  ...
  function fromExcel(){
    ...
    diag.URL = '<%=basePath%>rectifyinfo/goUploadExcelSNC.do';
    diag.Width = 300;
    diag.Height = 150;
    diag.CancelEvent = function(){ //关闭事件
      if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
