...
<%--								<td style="vertical-align:top;padding-left:2px;">--%>
<%--									<select class="chosen-select form-control" name="RECTIFY_STAGE" id="RECTIFY_STAGE" data-placeholder="隐患阶段" style="vertical-align:top;width: 120px;">--%>
<%--										<option value="">全部</option>--%>
...
<%--						</table>--%>
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
									<thead>
										<tr>
											...
											<th class="center" style="width:400px;">安全隐患编码</th>
											<th class="center" style="width:300px;">组织机构</th>
											<th class="center" style="width:150px;">项目名称</th>
											<th class="center" style="width:200px;">文件编号</th>
											...
											<th class="center" style="width:300px;">第一填报单位</th>
											<th class="center" style="width:200px;">第一填报人</th>
											<th class="center" style="width:300px;">整改措施</th>
											<th class="center" style="width:300px;">责任单位</th>
											...
											<th class="center" style="width:300px;">填报单位</th>
											<th class="center" style="width:200px;">填报人</th>
											<th class="center" style="width:350px;">备注</th>
											<th class="center" style="width:200px;">发现时间</th>
										</tr>
									</thead>
										...
										<c:when test="${not empty varList}">
											...
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
													...
													<td class='center'>
														<c:choose>
															<c:when test="${fn:length(var.RECTIFY_MEASURES) > 30}">
																<c:out value="${fn:substring(var.RECTIFY_MEASURES, 0, 30)}......" />
															</c:when>
															<c:otherwise>
																<c:out value="${var.RECTIFY_MEASURES}" />
															</c:otherwise>
														</c:choose>
													</td>
													<td class='center'>
	...
	<script type="text/javascript">
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>rectifyinfo/goEdit.do?RECTIFY_ID='+Id;
			 diag.Width = 900;
			 diag.Height = 800;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
		...
		function fromExcel(){
			 ...
			 diag.URL = '<%=basePath%>rectifyinfo/goUploadExcelHis.do';
			 diag.Width = 300;
			 diag.Height = 150;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
