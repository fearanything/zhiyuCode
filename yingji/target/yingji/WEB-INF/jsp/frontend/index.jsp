    ...
    <div class="left-container">
        <div class="top-box">
            ...
            <div class="systemSelect">
                ...
                <a target="_blank" href="<%=basePath%>hkSafeFrontend/index">安全隐患管理模块</a>
                <a target="_blank" href="<%=basePath%>fengXianFrontend/index">安全风险管理模块</a>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        // 项目总数数据
        var projectPre = prevProjectList - projectList;
        var projectCur = projectList;
        var projectBox = $('#projectNum');
        // 安全隐患数据
        var yinhuanPre = prevRectifyInfoList - rectifyInfoList;
        var yinhuanCur = rectifyInfoList;
        var yinhuanBox = $('#yinhuanNum');
        // 风险总数数据
        var fengxianPre = prevFengXianList - fengXianList;
        var fengxianCur = fengXianList;
