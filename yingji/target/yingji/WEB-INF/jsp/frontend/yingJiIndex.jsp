...
<div class="viewpoint" id="main">
  ...
  <div class="bi" style="height: 1080px;transform:scale(0.8) translate(-50%,-50%); transform-origin: 0 0; position: absolute; left: 50%; top: 60%;">
    ...
    <div class="weather">
      ...
      <div class="taifeng" style="margin-top:1rem ; margin-bottom: .6rem;">
        <div style="display:flex; justify-content:space-between;">
          <h3 style="width: 100%;margin-top:50px ; margin-bottom: 20px; padding-left: 1.5rem; font-weight: 400; background-image: url(<%=basePath%>frontend/images/title-bg2.png);background-size: cover;height: 2.5rem;line-height: 2.5rem ;font-size: 1.8rem;">台风气象</h3>
          <a href="<%=basePath%>yjfhmFrontend/weather.html" style="margin-right: 15px;margin-top:50px;width: 6.8rem; height: 2.4rem;line-height: 2.4rem;color: #fff; text-align: center; font-size: 14px;">进入详细</a>
        </div>
      ...
      <div class="qixiang" >
        <div class="title" style="margin-top:20px ;">
          <h3 style="padding-left: 1rem;background-image: url(<%=basePath%>frontend/images/title-bg2.png);background-size: cover;width: 100%;height: 2.5rem;line-height: 2.5rem ;font-size: 1.8rem; font-weight: 400;">气象信息</h3>
          <p style="font-size:1.5rem;width: 100% ;overflow: hidden; text-overflow: ellipsis;-webkit-line-clamp:3;-webkit-box-orient:vertical; padding: 15px;">
            ${weatherStr}
          </p>
        </div>
      </div>
    ...
    <!-- 4.右边值班信息开始 -->
    <div class="zhiban">
      <div class="title" style="display: flex;justify-content: space-between;margin-bottom: 30px; background-image: url(./images/title-bg3.png); width: 100%; background-size: 100% 100%;">
        <h3 style="background-image: url(<%=basePath%>frontend/images/title-bg3.png);background-size: 100% 100%;width: 100%;height: 2.5rem;line-height: 2.5rem ;font-size: 1.8rem; padding-left: 1rem; font-weight:400 ;">值班信息</h3>
        <a href="<%=basePath%>yjfhmFrontend/zhibanMsg.html" style="margin-right: 15px;width: 6.8rem; height: 2.4rem;line-height: 2.4rem;color: #fff; text-align: center; font-size: 14px;">进入详细</a>
      </div>
      ...
      <div class="waterData">
        <div class="dataTitle" style="display:flex ; justify-content: space-between; background-image: url(<%=basePath%>frontend/images/title-bg3.png);background-size: 100% 100%; padding: 0 1rem; margin-left: .2rem; margin-top: 30px;width: 100%;">
          <h3 style="font-weight: 400; font-size: 1.8rem;">近期水情数据</h3>
          <a href="<%=basePath%>yjfhmFrontend/yingji_shuiba.html" style=" width: 6.8rem ;height: 2.4rem; line-height: 2.4rem;font-size: 14px; text-align: center; color: #fff;">进入详细</a>
        </div>
      ...
      <div class="xiangmuList">
        <div class="xiangmuTitle" style="margin-bottom:.4rem ; margin-top: 30px;display: flex;justify-content:space-between;">
          <h3 style=" background-image: url(<%=basePath%>frontend/images/title-bg3.png); background-size: 100% 100%; width: 100%;height: 2.5rem;line-height: 2.5rem; padding-left: 1rem; font-weight: 400; font-size: 1.8rem;">项目列表</h3>
          <a href="<%=basePath%>yjfhmFrontend/yingji_gongcheng.html" style="margin-right: 15px;width: 6.8rem; height: 2.4rem;line-height: 2.4rem;color: #fff; text-align: center; font-size: 14px;">进入详细</a>
        </div>
