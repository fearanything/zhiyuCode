						            ...
						            <div class="tab-content">
									  ...
									  <div id="profile4" class="tab-pane">
										...
										<table id="table_report" class="table table-striped table-bordered table-hover">
											...
											<tr>
												<td style="width:88px;text-align: right;padding-top: 13px;">审核开关：</td>
												<td colspan="3">
													<label style="float:left;padding-left: 5px;padding-top:7px;">
														<input name="login-field-1" onclick="changeSwitch('isApprove');" class="ace ace-switch ace-switch-3" type="checkbox" <c:if test="${pd.isApprove == 'yes' }">checked="checked"</c:if> >
														<span class="lbl"></span>
													</label>
												</td>
											</tr>
										...
										<input type="hidden" name="isApprove" id="isApprove" value="${pd.isApprove }"/>
