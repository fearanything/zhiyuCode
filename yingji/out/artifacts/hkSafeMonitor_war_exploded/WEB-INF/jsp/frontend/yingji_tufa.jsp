...
<body id="main">
    ...
    <div class="content">
        <div class="tabhead">
            ...
            <h4>
                <a href="<%=basePath%>frontend/yingji.html">响应级别</a>
            </h4>
            <h4>
                <a href="<%=basePath%>frontend/yingji_tufa.html" class="tabActive">突发情况记录</a>
            </h4>
            <h4>
                <a href="<%=basePath%>frontend/yingji_fangxun.html">防汛风险情况</a>
            </h4>
        </div>
 ...
 <script src="<%=basePath%>frontend/js/time.js"></script>
    ...
    <style>
        ...
        .tabhead h3{
            background-image: url(<%=basePath%>frontend/images/yingjiRedBox.png);
            background-size: cover;
            width: 13rem;
            height: 2.5rem;
            line-height: 2.5rem;
