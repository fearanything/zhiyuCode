							...
							<tr>
								...
								<td style="padding-left:2px;">
									<div class="input-daterange input-group">
										<input type="text" class="input-sm form-control" id="start" value="${pd.start}" name="start" placeholder="上报时间" type="text" readonly="readonly"/>
										<span class="input-group-addon">
											<i class="fa fa-exchange"></i>
										</span>
										<input type="text" class="input-sm form-control" id="end" value="${pd.end}" name="end" placeholder="上报时间" type="text" readonly="readonly"/>
									</div>
								</td>
										...
										<c:when test="${not empty varList}">
											...
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
													...
													<td class='center'>${var.HIDDEN_DANGER_INFO}</td>
													...
													<td class='center'>
														<c:forEach items="${YesNoMap}" var="map" varStatus="vs">
															<c:if test="${map.key == var.IS_COMPLETE}">${map.value}</c:if>
														</c:forEach>
													</td>
