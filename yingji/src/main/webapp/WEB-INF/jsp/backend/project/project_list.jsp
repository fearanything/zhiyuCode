						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="PROJECTTYPE_ID" id="PROJECTTYPE_ID" data-placeholder="项目分类" style="vertical-align:top;width: 120px;">
										<option value=""></option>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="CITY_ID" id="CITY_ID" data-placeholder="所在城市" style="vertical-align:top;width: 120px;">
										<option value=""></option>
										<option value="">全部</option>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">项目分类</th>
									<th class="center">所在城市</th>
									<th class="center">工程项目名称</th>
