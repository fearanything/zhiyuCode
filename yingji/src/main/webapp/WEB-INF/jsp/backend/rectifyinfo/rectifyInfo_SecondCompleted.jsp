      ...
      <div class="page-content">
        <div class="row">
          <div class="col-xs-12">
            ...
            <!-- 检索  -->
            <form action="rectifyinfo/goRectifyInfoSC?RECTIFY_STAGE=3" method="post" name="Form" id="Form">
...
<script type="text/javascript">
  ...
  function edit(Id){
    ...
    diag.Drag=true;
    diag.Title ="编辑";
    diag.URL = '<%=basePath%>rectifyinfo/goEdit.do?RECTIFY_ID='+Id+"&RECTIFY_STAGE=3";
    diag.Width = 900;
    diag.Height = 800;
    diag.Modal = true;				//有无遮罩窗口
    diag. ShowMaxButton = true;	//最大化按钮
  ...
  function fromExcel(){
    ...
    diag.URL = '<%=basePath%>rectifyinfo/goUploadExcelSC.do';
    diag.Width = 300;
    diag.Height = 150;
    diag.CancelEvent = function(){ //关闭事件
      if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
