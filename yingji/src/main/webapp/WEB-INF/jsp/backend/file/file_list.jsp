						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="FILETYPE_ID" id="FILETYPE_ID" data-placeholder="文件分类" style="vertical-align:top;width: 120px;">
										<option value=""></option>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center" style="width:20%;">文件分类</th>
									<th class="center" style="width:50%;">文件名称</th>
									<th class="center" style="width:10%;">文件浏览</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>
											<a class="btn btn-xs btn-success" title="下载" onclick="window.location.href='<%=basePath%>/${var.FILE_URL}'">
