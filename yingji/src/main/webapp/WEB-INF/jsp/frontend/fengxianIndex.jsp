  ...
  $(document).ready(function () {
            ...
            formatter: function (params) {
              for(var i = 0;i<allData.length;i++){
                if(params.name== allData[i].NAME && params.name=='海口市'){
                  ...
                  otherHtml += ' <div class="total">风险统计<span>' + (allData[i].tongJi || 0) + '</span>个</div> </div> <div class="otherList"> <div class="item"> <p>风险等级</p > <div class="point"> <div class="fengxian"> <img src="<%=basePath%>/frontend/images/great-icon.png" alt=""></img> <div class="num"> <p>重大风险</p >';
                  otherHtml += '<div id="zd">'+ (allData[i].MAJOR_RISK  || 0) +'个</div>';
                  otherHtml += ' </div> </div> <div class="fengxian"> <img src="<%=basePath%>/frontend/images/larger-icon.png" alt=""></img> <div class="num"> <p>较大风险</p >';
                  otherHtml += '<div id="jd">'+ (allData[i].MORE_RISK  || 0) +'个</div>';
                  otherHtml += '</div> </div> <div class="fengxian"> <img src="<%=basePath%>/frontend/images/common-icon.png" alt=""></img> <div class="num"> <p>一般风险</p >';
                  otherHtml += '<div id="yb">' + (allData[i].NORMAL_RISK || 0) + '个</div>';
                  otherHtml += '</div> </div> <div class="fengxian"> <img src="<%=basePath%>/frontend/images/low-icon.png" alt=""></img> <div class="num"> <p>低风险</p >';
                  otherHtml += ' <div id="dd">'+ (allData[i].LOW_RISK || 0) +'个</div>';
    ...
    function secondUnit(){
      ...
      for(var i = 0;i<secondUnitData.length;i++){
        ...
        secondUnitHtml += '<img class="logo" src="<%=basePath%>/frontend/images/hkLogo.jpg" alt=""></img>';
        secondUnitHtml += '<div class="detail">';
        secondUnitHtml += '<a href="<%=basePath%>/fengXianFrontend/fengXianERJi?ORG_ID='+secondUnitData[i].org_id+' " class="name">'+ secondUnitData[i].org_name +'</a>';
