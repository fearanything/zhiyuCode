								...
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><input type="text" name="USERNUM" id="USERNUM" value="${pd.USERNUM }" maxlength="32" placeholder="这里输入编号" title="编号" onblur="hasN('${pd.USERNAME }')" style="width:98%;"/></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
											<input type="text" name="NAME" id="name" value="${pd.NAME }" maxlength="32" placeholder="这里输入单位名称" title="单位名称" style="width:98%;"/>
...
<script type="text/javascript">
	...
	function hasN(USERNAME){
		...
		$.ajax({
	    	...
	    	data: {USERNUM:USERNUM,USERNAME:USERNAME,tm:new Date().getTime()},
			dataType:'json',
			cache: false,
			success: function(data){
				 if("success" != data.result){
