...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements com.fh.util.WebXml.WeatherWebService {
 ...
 */
    ...
    public com.fh.util.WebXml.WeatherWebServiceSoap getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.fh.util.WebXml.WeatherWebServiceSoap getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.fh.util.WebXml.WeatherWebServiceSoapStub _stub = new com.fh.util.WebXml.WeatherWebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.fh.util.WebXml.WeatherWebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
            	com.fh.util.WebXml.WeatherWebServiceSoapStub _stub = new com.fh.util.WebXml.WeatherWebServiceSoapStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
